...
namespace Networking.Server {
    public class WSChunk {
        ...
        public bool AddEntityUpdate(int tick, int id, INetSerializable update) {
            ...
            if (!entityUpdates[tick % WCommon.TICKS_PER_SNAPSHOT].TryGetValue(id, out var entityUpdatesList)) {
                List<INetSerializable> newEntityUpdatesList = new();
                entityUpdates[tick % WCommon.TICKS_PER_SNAPSHOT].Add(id, newEntityUpdatesList);
