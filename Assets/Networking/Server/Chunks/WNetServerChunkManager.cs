...
namespace Networking.Server {
    public static class WNetServerChunkManager {
        private const float chunkSize = 32;
        private static Dictionary<Vector2Int, WNetChunk> loadedChunks = new();

        public static HashSet<Vector2Int> chunksMarkedToUnload = new();


        public static void ResetChunkUpdatesAndSnapshots() {
            foreach(WNetChunk chunk in loadedChunks.Values) {
                chunk.ResetUpdates();
            }
        }
        ...
        public static WNetChunk GetChunk(Vector2Int coords, bool createIfNotExists = false) {
            if(loadedChunks.TryGetValue(coords, out WNetChunk chunk))
                return chunk;
        ...
        public static void RemoveChunkLoader(Vector2Int coords, WNetServerEntity entity, bool removeFromAllNearbyChunks = false) {
        ...
        public static void AddChunkLoader(Vector2Int coords, WNetServerEntity entity, bool addToAllNearbyChunks = false) {
        ...
        private static void MoveChunkLoader(WNetServerEntity entity, Vector2Int from, Vector2Int to) {
        ...
        public static WNetChunk MoveEntityBetweenChunks(WNetServerEntity entity, Vector2Int from, Vector2Int to) {
